...
#include <memory>
#include "../QTracker_booster_G4040/IO/serialport.h"
...
QT_MOC_LITERAL(4, 26, 10), // "handleData"
QT_MOC_LITERAL(5, 37, 9), // "writeData"
QT_MOC_LITERAL(6, 47, 11), // "const char*"
QT_MOC_LITERAL(7, 59, 3) // "len"

    },
    "SerialPort\0recvData\0\0data\0handleData\0"
...
static const uint qt_meta_data_SerialPort[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 6, QMetaType::LongLong,    3,    7,
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->writeData((*reinterpret_cast< const char*(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPort::recvData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::recvData(QByteArray _t1)
{
